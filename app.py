...
st.markdown("<h1 style='text-align: center; color: #157DDA;'><strong><u>Predict Blood Transfusion with Logistic Regression</u></strong></h1>", unsafe_allow_html=True)

image = Image.open('blood.jpg')
st.image(image,width=700)

st.sidebar.markdown("<h1 style='text-align: center; color:#157DDA ;'><strong><u>Specify Input Parameters</u></strong></h1>", unsafe_allow_html=True)
